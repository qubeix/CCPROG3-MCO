/**
  ...
  * the unique method of: updating the album entry's current track progress, and returning its information via String
 */
public class Album extends MediaEntry
{
	...
	/**
     * Returns a String containing the information of the album (title, artist, genre, and tracks (and if the entry is completed, rating and review))
     */
